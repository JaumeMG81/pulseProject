    ...
    <div class="container-fluid">
        ...
        <nav class="navbar" id="myScrollspy">
            ...
            <ul class="nav navbar-nav">
                <li class="active"><a href="#scroll1">Inicio</a></li>
                <li><a href="#scroll2">Digital pulse</a></li>
                <li><a href="#scroll3">Pulse</a></li>
                <li><a href="#scroll4">Toma tu pulso digital</a></li>
                <li><a href="#scroll5">Modalidades</a></li>
                <li><a href="#scroll6">Contacto</a></li>
            </ul>
        </nav>
        ...
        <!--<img class="fixedGif" src="./pulse.gif"/>-->
            ...
            <div class="parallax-window" data-parallax="scroll" data-image-src="images/thread.gif"></div>
      		...
      		<div id="scroll5">    
                ...
                <form>
                  ...
                  <div class="form-group">
                    <label for="textarea">Telèfono</label>
...
<div class="parallax-window" data-parallax="scroll" data-image-src="images/thread.gif"></div>
            ...
            <h1>Section 6</h1>  
                ...
                <div class="col-md-3 col-sm-6">
                <div class="footer-info-single">
                    <h2 class="title">Security i privacy</h2>
                    <ul class="list-unstyled">
